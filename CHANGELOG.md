...
- Bumped MCP manifest version to `0.1.5` for this public metadata update.
...
- Registry ID (`ai.urlcheck/urlcheck-mcp`), endpoint (`urlcheck.ai/mcp`), and tool names remain unchanged for backward compatibility.
